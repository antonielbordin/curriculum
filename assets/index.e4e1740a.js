const G=function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const o of c.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerpolicy&&(c.referrerPolicy=l.referrerpolicy),l.crossorigin==="use-credentials"?c.credentials="include":l.crossorigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(l){if(l.ep)return;l.ep=!0;const c=t(l);fetch(l.href,c)}};G();function r(){}function V(e){return e()}function D(){return Object.create(null)}function $(e){e.forEach(V)}function J(e){return typeof e=="function"}function A(e,s){return e!=e?s==s:e!==s||e&&typeof e=="object"||typeof e=="function"}function Q(e){return Object.keys(e).length===0}function w(e,s){e.appendChild(s)}function B(e,s,t){e.insertBefore(s,t||null)}function u(e){e.parentNode.removeChild(e)}function k(e){return document.createElement(e)}function W(e){return document.createTextNode(e)}function j(){return W(" ")}function d(e,s,t){t==null?e.removeAttribute(s):e.getAttribute(s)!==t&&e.setAttribute(s,t)}function z(e){return Array.from(e.childNodes)}let q;function h(e){q=e}const b=[],H=[],x=[],R=[],K=Promise.resolve();let N=!1;function X(){N||(N=!0,K.then(U))}function P(e){x.push(e)}const I=new Set;let m=0;function U(){const e=q;do{for(;m<b.length;){const s=b[m];m++,h(s),Y(s.$$)}for(h(null),b.length=0,m=0;H.length;)H.pop()();for(let s=0;s<x.length;s+=1){const t=x[s];I.has(t)||(I.add(t),t())}x.length=0}while(b.length);for(;R.length;)R.pop()();N=!1,I.clear(),h(e)}function Y(e){if(e.fragment!==null){e.update(),$(e.before_update);const s=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,s),e.after_update.forEach(P)}}const g=new Set;let Z;function _(e,s){e&&e.i&&(g.delete(e),e.i(s))}function L(e,s,t,n){if(e&&e.o){if(g.has(e))return;g.add(e),Z.c.push(()=>{g.delete(e),n&&(t&&e.d(1),n())}),e.o(s)}else n&&n()}function C(e){e&&e.c()}function y(e,s,t,n){const{fragment:l,on_mount:c,on_destroy:o,after_update:p}=e.$$;l&&l.m(s,t),n||P(()=>{const i=c.map(V).filter(J);o?o.push(...i):$(i),e.$$.on_mount=[]}),p.forEach(P)}function T(e,s){const t=e.$$;t.fragment!==null&&($(t.on_destroy),t.fragment&&t.fragment.d(s),t.on_destroy=t.fragment=null,t.ctx=[])}function ee(e,s){e.$$.dirty[0]===-1&&(b.push(e),X(),e.$$.dirty.fill(0)),e.$$.dirty[s/31|0]|=1<<s%31}function S(e,s,t,n,l,c,o,p=[-1]){const i=q;h(e);const a=e.$$={fragment:null,ctx:null,props:c,update:r,not_equal:l,bound:D(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(s.context||(i?i.$$.context:[])),callbacks:D(),dirty:p,skip_bound:!1,root:s.target||i.$$.root};o&&o(a.root);let f=!1;if(a.ctx=t?t(e,s.props||{},(v,O,...M)=>{const F=M.length?M[0]:O;return a.ctx&&l(a.ctx[v],a.ctx[v]=F)&&(!a.skip_bound&&a.bound[v]&&a.bound[v](F),f&&ee(e,v)),O}):[],a.update(),f=!0,$(a.before_update),a.fragment=n?n(a.ctx):!1,s.target){if(s.hydrate){const v=z(s.target);a.fragment&&a.fragment.l(v),v.forEach(u)}else a.fragment&&a.fragment.c();s.intro&&_(e.$$.fragment),y(e,s.target,s.anchor,s.customElement),U()}h(i)}class E{$destroy(){T(this,1),this.$destroy=r}$on(s,t){const n=this.$$.callbacks[s]||(this.$$.callbacks[s]=[]);return n.push(t),()=>{const l=n.indexOf(t);l!==-1&&n.splice(l,1)}}$set(s){this.$$set&&!Q(s)&&(this.$$.skip_bound=!0,this.$$set(s),this.$$.skip_bound=!1)}}function se(e){let s;return{c(){s=k("header"),s.innerHTML=`<h1 class="svelte-18ec35p">Antoniel Bordin</h1> 
    <h2 class="svelte-18ec35p">Information systems analyst &amp; web developer</h2>`,d(s,"id","header"),d(s,"class","svelte-18ec35p")},m(t,n){B(t,s,n)},p:r,i:r,o:r,d(t){t&&u(s)}}}class te extends E{constructor(s){super(),S(this,s,null,se,A,{})}}function le(e){let s;return{c(){s=k("aside"),s.innerHTML=`<span class="triangle svelte-kq9rba"></span>  
